...
const ProfilePanel = ({ isOpen }) => {
  ...
  const handleAddRelative = (relationType) => {
    ...
    const newNodeId = addNode({
      firstName: 'Nowa', lastName: 'Osoba', maidenName: '', birthDate: '', deathDate: '', bio: '', gender: isPartner ? (formData.gender === 'male' ? 'female' : 'male') : 'male',
    ...
    <div className="glass-panel" style={{
      ...
      <div style={{ padding: '24px', flex: 1, overflowY: 'auto' }}>
        ...
        <div style={{ marginTop: '48px' }}>
          <button className="btn" style={{ width: '100%', justifyContent: 'center', backgroundColor: 'rgba(239, 68, 68, 0.2)', color: '#ef4444', border: '1px solid rgba(239, 68, 68, 0.5)' }} 
            onClick={() => {
